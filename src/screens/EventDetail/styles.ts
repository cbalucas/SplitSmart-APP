...
export const createStyles = (theme: Theme) => StyleSheet.create({
  ...
  // ── Modal cierre con liquidaciones pendientes ─────────────
  closeWithPendingOverlay: {
    flex: 1,
  ...
  closeWithPendingHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
    marginBottom: 12,
  },
  closeWithPendingTitle: {
    fontSize: 17,
    fontWeight: '700',
    color: theme.colors.onSurface,
    flex: 1,
  },
  closeWithPendingDesc: {
    fontSize: 14,
    color: theme.colors.onSurfaceVariant,
    marginBottom: 16,
    lineHeight: 20,
  ...
  closeWithPendingFooter: {
    flexDirection: 'row',
    gap: 10,
  },
  closeWithPendingCancelBtn: {
    flex: 1,
    paddingVertical: 12,
    borderRadius: 12,
    borderWidth: 1,
  ...
  closeWithPendingCancelText: {
    fontSize: 14,
    fontWeight: '600',
    color: theme.colors.onSurfaceVariant,
  },
  closeWithPendingConfirmBtn: {
    flex: 2,
    paddingVertical: 12,
    borderRadius: 12,
  ...
  activityModalBtnCancel: {
    backgroundColor: theme.colors.surfaceVariant,
  },
  activityModalBtnCancelText: {
    fontSize: 14,
    fontWeight: '600',
    color: theme.colors.onSurfaceVariant,
  },
  activityModalBtnSave: {
    backgroundColor: '#FF6F00',
  },
  activityModalBtnSaveText: {
    fontSize: 14,
    fontWeight: '700',
    color: '#fff',
  },
  ...
  activityTemplateMain: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  },
  activityTemplateSectionRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    marginTop: 12,
  ...
  activityTemplateTasks: {
    fontSize: 12,
    color: theme.colors.onSurfaceVariant,
    marginTop: 2,
  },
  activitySaveTemplateBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
    gap: 8,
