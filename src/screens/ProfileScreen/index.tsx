                ...
                {expandedVersions.has('1.5.0') && (
                  <View style={styles.versionContent}>
                    <View style={styles.changelogSection}>
                      ...
                      <Text style={styles.changelogItem}>• EventDetail: Tab Resumen</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Tab Resumen</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Tab Participantes</Text>
                    ...
                    <View style={styles.changelogSection}>
                      ...
                      <Text style={styles.changelogItem}>• database.ts: no hidrataba el campo</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Tab Participantes mostraba incorrecto en gastos multi-pagador</Text>
                      <Text style={styles.changelogItem}>• database.ts: eliminaba amigos permanentes de la app</Text>
                      <Text style={styles.changelogItem}>• AddParticipantModal: Re-renders y pantalla con comportamiento errático al tipear nombre</Text>
                    </View>
                    <View style={styles.changelogSection}>
                      <Text style={styles.sectionTitle}>? Mejoras</Text>
                      <Text style={styles.changelogItem}>• ManageFriends: Nuevas traducciones de validación de nombre () en ES, EN y PT, en archiv...</Text>
                      <Text style={styles.changelogItem}>• AddParticipantModal: Nuevas claves de traducción () en ES, EN y PT dentro de .</Text>
                      <Text style={styles.changelogItem}>• LanguageContext: Nuevas claves para flujo de amigo duplicado en EventDetail (, , , , ) ...</Text>
                      <Text style={styles.changelogItem}>• LanguageContext: Nuevas claves para eliminación múltiple de participantes (, , , , , , ...</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Tab Participantes</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Cards de participantes</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Cards de participantes</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Cards de participantes</Text>
                      <Text style={styles.changelogItem}>• LanguageContext: Nuevas claves para liquidaciones pagadas (, , ) en ES, EN y PT.</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Tab Resumen</Text>
                      <Text style={styles.changelogItem}>• LanguageContext: Nuevas claves para eliminación múltiple de gastos (, , , , , ) en ES (...</Text>
                      <Text style={styles.changelogItem}>• EventDetail: Tab Gastos</Text>
                    </View>
                  </View>
                )}
                ...
                {expandedVersions.has('1.4.10') && (
                  <View style={styles.versionContent}>
                    <View style={styles.changelogSection}>
                      ...
                      <Text style={styles.changelogItem}>• ProfileScreen: Labels y se mostraban como clave sin traducir</Text>
                      <Text style={styles.changelogItem}>• ProfileScreen: Bloque v1.4.9 ausente en el historial modal</Text>
                    </View>
                    <View style={styles.changelogSection}>
                      <Text style={styles.sectionTitle}>? Mejoras</Text>
                      <Text style={styles.changelogItem}>• : Búsqueda del marcador de versión con regex</Text>
                    </View>
                  </View>
                )}
              </TouchableOpacity>

{/* Versión 1.4.9 - Versión Actual */}
              <TouchableOpacity 
                style={[styles.versionBlock]} 
                ...
                {expandedVersions.has('1.4.9') && (
                  <View style={styles.versionContent}>
                    ...
                    <View style={styles.changelogSection}>
                      ...
                      <Text style={styles.changelogItem}>• versiones.ps1: flujo Copilot integrado</Text>
                    </View>
                  </View>
                )}
              </TouchableOpacity>
                ...
                {expandedVersions.has('1.3.0') && (
                  <View style={styles.versionContent}>
                    <View style={styles.changelogSection}>
                      ...
                      <Text style={styles.changelogItem}>• Contador de liquidaciones ?? (pagadas/total) en card</Text>
            ...
            >
              {databaseStats ? (
                <>
                  ...
                  >
                    <Text style={{ color: theme.colors.onSurfaceVariant, fontSize: 14 }}>?? Información técnica</Text>
